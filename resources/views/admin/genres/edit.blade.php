...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.genres.index') }}">{{__('genres')}}</a></li>
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.genres.update', $genre->id) }}">
                    ...
                    <div class="form-group">
                        <label>{{__('genre name')}} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="animated-checkbox mx-2" style="display:inline-block;">
                                            <label class="m-0">
                                                <input type="checkbox" value="{{ $permissionMap . '_' . $model }}"
                                                       name="permissions[]"
                                                       {{ $genre->hasPermission( $permissionMap . '_' . $model) ? 'checked' : '' }} class="genre">
